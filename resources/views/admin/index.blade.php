                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="row mb-0">
                                                ...
                                                <div class="col">
                                                    <form onsubmit="return confirm('Do you really want to delete?');"action="{{route('admins.destroy',$admin->id)}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf()
...
<div class="fixed-action-btn">
    <a class="btn-floating btn-large waves=effect waves-light blue" href="{{route('admins.create')}}">
