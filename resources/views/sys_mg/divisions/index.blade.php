...
@section('content')
<div class="container">
    <h4 class="grey-text text-darken-2 center"></h4>
                                        ...
                                        <td>
                                            <div class="row mb-0">
                                              <div class="col">
                                                ...
                                                <div class="col">
                                                    <form onsubmit="return confirm('Do you really want to delete?');"action="{{route('divisions.destroy',$division->id)}}" method="POST">
                                                        @method('DELETE')
                                                        @csrf()
...
<div class="fixed-action-btn">
    <a class="btn-floating btn-large waves=effect waves-light  blue" href="{{route('divisions.create')}}">
